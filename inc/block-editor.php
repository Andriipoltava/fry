...
add_action( 'after_setup_theme', 'fry_theme_block_editor_setup' );

if ( ! function_exists( 'fry_theme_block_editor_setup' ) ) {
	 ...
	 * @since 1.0.0
	 */
	function fry_theme_block_editor_setup() {
		...
		$color_palette = fry_theme_generate_color_palette();
		if ( $color_palette ) {
...
if ( ! function_exists( 'fry_theme_generate_color_palette' ) ) {
	/**
	 ...
	 * @return array
	 */
	function fry_theme_generate_color_palette() {
		$color_palette = array();
		 ...
		 */
		return apply_filters( 'fry_theme_theme_editor_color_palette', $color_palette );
	}
}
