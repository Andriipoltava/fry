...
if ( ! function_exists( 'fry_theme_add_widget_categories_class' ) ) {
	/**
	 ...
	 */
	function fry_theme_add_widget_categories_class( $cat_args ) {

		if ( isset( $cat_args['class'] ) ) {
			$cat_args['class'] .= ' ' . fry_theme_get_select_control_class();
		} else {
			$cat_args['class'] = fry_theme_get_select_control_class();
		}
...
add_filter( 'widget_categories_dropdown_args', 'fry_theme_add_widget_categories_class' );

if ( ! function_exists( 'fry_theme_add_block_widget_categories_class' ) ) {
	/**
	 ...
	 */
	function fry_theme_add_block_widget_categories_class( $output, $parsed_args ) {
		$class = fry_theme_get_select_control_class();
...
add_filter( 'wp_dropdown_cats', 'fry_theme_add_block_widget_categories_class', 10, 2 );

if ( ! function_exists( 'fry_theme_add_block_widget_archives_classes' ) ) {
	/**
	 ...
	 */
	function fry_theme_add_block_widget_archives_classes( $block_content, $block ) {

		if ( isset( $block['attrs']['displayAsDropdown'] ) && true === $block['attrs']['displayAsDropdown'] ) {
			return str_replace(
				'<select',
				'<select class="' . fry_theme_get_select_control_class() . '"',
				$block_content
			);
		}
...
add_filter( 'render_block_core/archives', 'fry_theme_add_block_widget_archives_classes', 10, 2 );

if ( ! function_exists( 'fry_theme_add_block_widget_search_classes' ) ) {
	/**
	 ...
	 * @return string The filtered block content.
	 */
	function fry_theme_add_block_widget_search_classes( $block_content, $block ) {
...
add_filter( 'render_block_core/search', 'fry_theme_add_block_widget_search_classes', 10, 2 );
 ...
 */
function fry_theme_hero_active_carousel_item( $params ) {
	if (
		! isset( $params[0] )
		|| ! isset( $params[0]['id'] )
		|| 'hero' !== $params[0]['id']
...
add_filter( 'dynamic_sidebar_params', 'fry_theme_hero_active_carousel_item' );
 ...
 */
add_filter( 'dynamic_sidebar_params', 'fry_theme_widget_classes' );

if ( ! function_exists( 'fry_theme_widget_classes' ) ) {
	 ...
	 * @return array Maybe filtered parameters.
	 */
	function fry_theme_widget_classes( $params ) {
...
} // End of if function_exists( 'fry_theme_widget_classes' ).

add_action( 'widgets_init', 'fry_theme_widgets_init' );

if ( ! function_exists( 'fry_theme_widgets_init' ) ) {
	/**
	 * Initializes themes widgets.
	 */
	function fry_theme_widgets_init() {
		register_sidebar(
			array(
				/* translators: Widget area title */
				'name'          => __( 'Right Sidebar', 'fry_theme' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'fry_theme' ),
		...
		register_sidebar(
			array(
				/* translators: Widget area title */
				'name'          => __( 'Left Sidebar', 'fry_theme' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'fry_theme' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				/* translators: Widget area title */
				'name'          => __( 'Hero Slider', 'fry_theme' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'fry_theme' ),
		...
		register_sidebar(
			array(
				/* translators: Widget area title */
				'name'          => __( 'Hero Canvas', 'fry_theme' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'fry_theme' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				/* translators: Widget area title */
				'name'          => __( 'Top Full', 'fry_theme' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'fry_theme' ),
		...
		register_sidebar(
			array(
				/* translators: Widget area title */
				'name'          => __( 'Footer Full', 'fry_theme' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'fry_theme' ),
...
} // End of function_exists( 'fry_theme_widgets_init' ).
